...
impl super::Gpio {
    ...
    #[inline(always)]
    pub const fn gpio_pup_pdn_cntrl_reg0(
        &self,
    ) -> &'static crate::common::Reg<self::GpioPupPdnCntrlReg0_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::GpioPupPdnCntrlReg0_SPEC, crate::common::RW>::from_ptr(
    ...
    #[inline(always)]
    pub const fn gpio_pup_pdn_cntrl_reg1(
        &self,
    ) -> &'static crate::common::Reg<self::GpioPupPdnCntrlReg1_SPEC, crate::common::R> {
        unsafe {
            crate::common::Reg::<self::GpioPupPdnCntrlReg1_SPEC, crate::common::R>::from_ptr(
    ...
    #[inline(always)]
    pub const fn gpio_pup_pdn_cntrl_reg2(
        &self,
    ) -> &'static crate::common::Reg<self::GpioPupPdnCntrlReg2_SPEC, crate::common::R> {
        unsafe {
            crate::common::Reg::<self::GpioPupPdnCntrlReg2_SPEC, crate::common::R>::from_ptr(
    ...
    #[inline(always)]
    pub const fn gpio_pup_pdn_cntrl_reg3(
        &self,
    ) -> &'static crate::common::Reg<self::GpioPupPdnCntrlReg3_SPEC, crate::common::R> {
        unsafe {
            crate::common::Reg::<self::GpioPupPdnCntrlReg3_SPEC, crate::common::R>::from_ptr(
...
pub mod gpfsel0 {
    ...
    impl Fsel0 {
        ...
        pub const PCLK: Self = Self::new(6);

        #[doc = "Pin is connected to SPI3_CE0_N"]
        pub const SPI_3_CE_0_N: Self = Self::new(7);

        #[doc = "Pin is connected to TXD2"]
        pub const TXD_2: Self = Self::new(3);

        #[doc = "Pin is connected to SDA6"]
        pub const SDA_6: Self = Self::new(2);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Fsel1 {
        ...
        pub const DE: Self = Self::new(6);

        #[doc = "Pin is connected to SPI3_MISO"]
        pub const SPI_3_MISO: Self = Self::new(7);

        #[doc = "Pin is connected to RXD2"]
        pub const RXD_2: Self = Self::new(3);

        #[doc = "Pin is connected to SCL6"]
        pub const SCL_6: Self = Self::new(2);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Fsel2 {
        ...
        pub const LCD_VSYNC: Self = Self::new(6);

        #[doc = "Pin is connected to SPI3_MOSI"]
        pub const SPI_3_MOSI: Self = Self::new(7);

        #[doc = "Pin is connected to CTS2"]
        pub const CTS_2: Self = Self::new(3);

        #[doc = "Pin is connected to SDA3"]
        pub const SDA_3: Self = Self::new(2);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Fsel3 {
        ...
        pub const LCD_HSYNC: Self = Self::new(6);

        #[doc = "Pin is connected to SPI3_SCLK"]
        pub const SPI_3_SCLK: Self = Self::new(7);

        #[doc = "Pin is connected to RTS2"]
        pub const RTS_2: Self = Self::new(3);

        #[doc = "Pin is connected to SCL3"]
        pub const SCL_3: Self = Self::new(2);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Fsel4 {
        ...
        pub const DPI_D_0: Self = Self::new(6);

        #[doc = "Pin is connected to SPI4_CE0_N"]
        pub const SPI_4_CE_0_N: Self = Self::new(7);

        #[doc = "Pin is connected to TXD3"]
        pub const TXD_3: Self = Self::new(3);
    ...
    impl Fsel5 {
        ...
        pub const DPI_D_1: Self = Self::new(6);

        #[doc = "Pin is connected to SPI4_MISO"]
        pub const SPI_4_MISO: Self = Self::new(7);

        #[doc = "Pin is connected to RXD3"]
        pub const RXD_3: Self = Self::new(3);
    ...
    impl Fsel6 {
        ...
        pub const DPI_D_2: Self = Self::new(6);

        #[doc = "Pin is connected to SPI4_MOSI"]
        pub const SPI_4_MOSI: Self = Self::new(7);

        #[doc = "Pin is connected to CTS3"]
        pub const CTS_3: Self = Self::new(3);

        #[doc = "Pin is connected to SDA4"]
        pub const SDA_4: Self = Self::new(2);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Fsel7 {
        ...
        pub const DPI_D_3: Self = Self::new(6);

        #[doc = "Pin is connected to SPI4_SCLK"]
        pub const SPI_4_SCLK: Self = Self::new(7);

        #[doc = "Pin is connected to RTS3"]
        pub const RTS_3: Self = Self::new(3);

        #[doc = "Pin is connected to SCL4"]
        pub const SCL_4: Self = Self::new(2);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Fsel8 {
        ...
        pub const DPI_D_4: Self = Self::new(6);

        #[doc = "Pin is connected to BSCSL_CE_N"]
        pub const BSCSL_CE_N: Self = Self::new(7);

        #[doc = "Pin is connected to TXD4"]
        pub const TXD_4: Self = Self::new(3);
    ...
    impl Fsel9 {
        ...
        pub const DPI_D_5: Self = Self::new(6);

        #[doc = "Pin is connected to BSCSL_MISO"]
        pub const BSCSL_MISO: Self = Self::new(7);

        #[doc = "Pin is connected to RXD4"]
        pub const RXD_4: Self = Self::new(3);
...
pub mod gpfsel1 {
    ...
    impl Fsel10 {
        ...
        pub const DPI_D_6: Self = Self::new(6);

        #[doc = "Pin is connected to BSCSL_MOSI"]
        pub const BSCSL_MOSI: Self = Self::new(7);

        #[doc = "Pin is connected to CTS4"]
        pub const CTS_4: Self = Self::new(3);

        #[doc = "Pin is connected to SDA5"]
        pub const SDA_5: Self = Self::new(2);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Fsel11 {
        ...
        pub const DPI_D_7: Self = Self::new(6);

        #[doc = "Pin is connected to BSCSL_SCLK"]
        pub const BSCSL_SCLK: Self = Self::new(7);

        #[doc = "Pin is connected to RTS4"]
        pub const RTS_4: Self = Self::new(3);

        #[doc = "Pin is connected to SCL5"]
        pub const SCL_5: Self = Self::new(2);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Fsel12 {
        ...
        pub const DPI_D_8: Self = Self::new(6);

        #[doc = "Pin is connected to SPI5_CE0_N"]
        pub const SPI_5_CE_0_N: Self = Self::new(7);

        #[doc = "Pin is connected to TXD5"]
        pub const TXD_5: Self = Self::new(3);
    ...
    impl Fsel13 {
        ...
        pub const DPI_D_9: Self = Self::new(6);

        #[doc = "Pin is connected to SPI5_MISO"]
        pub const SPI_5_MISO: Self = Self::new(7);

        #[doc = "Pin is connected to RXD5"]
        pub const RXD_5: Self = Self::new(3);
    ...
    impl Fsel14 {
        ...
        pub const DPI_D_10: Self = Self::new(6);

        #[doc = "Pin is connected to SPI5_MOSI"]
        pub const SPI_5_MOSI: Self = Self::new(7);

        #[doc = "Pin is connected to CTS5"]
        pub const CTS_5: Self = Self::new(3);
    ...
    impl Fsel15 {
        ...
        pub const DPI_D_11: Self = Self::new(6);

        #[doc = "Pin is connected to SPI5_SCLK"]
        pub const SPI_5_SCLK: Self = Self::new(7);

        #[doc = "Pin is connected to RTS5"]
        pub const RTS_5: Self = Self::new(3);
    ...
    impl Fsel16 {
        ...
        pub const DPI_D_12: Self = Self::new(6);
    ...
    impl Fsel17 {
        ...
        pub const DPI_D_13: Self = Self::new(6);
    ...
    impl Fsel18 {
        ...
        pub const DPI_D_14: Self = Self::new(6);

        #[doc = "Pin is connected to SPI6_CE0_N"]
        pub const SPI_6_CE_0_N: Self = Self::new(7);
    ...
    impl Fsel19 {
        ...
        pub const DPI_D_15: Self = Self::new(6);

        #[doc = "Pin is connected to SPI6_MISO"]
        pub const SPI_6_MISO: Self = Self::new(7);
...
pub mod gpfsel2 {
    ...
    impl Fsel20 {
        ...
        pub const DPI_D_16: Self = Self::new(6);

        #[doc = "Pin is connected to SPI6_MOSI"]
        pub const SPI_6_MOSI: Self = Self::new(7);
    ...
    impl Fsel21 {
        ...
        pub const DPI_D_17: Self = Self::new(6);

        #[doc = "Pin is connected to SPI6_SCLK"]
        pub const SPI_6_SCLK: Self = Self::new(7);
    ...
    impl Fsel24 {
        ...
        pub const SPI_3_CE_1_N: Self = Self::new(2);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Fsel25 {
        ...
        pub const SPI_4_CE_1_N: Self = Self::new(2);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Fsel26 {
        ...
        pub const SPI_5_CE_1_N: Self = Self::new(2);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Fsel27 {
        ...
        pub const SD_0_DAT_3: Self = Self::new(4);

        #[doc = "Alt function 1 reserved"]
        pub const RESERVED_1: Self = Self::new(5);

        #[doc = "Pin is connected to DPI_D23"]
        pub const DPI_D_23: Self = Self::new(6);
        ...
        pub const SPI_6_CE_1_N: Self = Self::new(2);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Fsel28 {
        ...
        pub const MII_A_RX_ERR: Self = Self::new(3);

        #[doc = "Pin is connected to RGMII_MDIO"]
        pub const RGMII_MDIO: Self = Self::new(2);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Fsel29 {
        ...
        pub const MII_A_TX_ERR: Self = Self::new(3);

        #[doc = "Pin is connected to RGMII_MDC"]
        pub const RGMII_MDC: Self = Self::new(2);
    }
}
#[doc(hidden)]
#[derive(Copy, Clone, Eq, PartialEq)]
...
pub mod gpfsel3 {
    ...
    impl Fsel30 {
        ...
        pub const MII_A_CRS: Self = Self::new(3);
    ...
    impl Fsel31 {
        ...
        pub const MII_A_COL: Self = Self::new(3);
    ...
    impl Fsel32 {
        ...
        pub const SD_CARD_PRES: Self = Self::new(3);
    ...
    impl Fsel33 {
        ...
        pub const SD_CARD_WRPROT: Self = Self::new(3);
    ...
    impl Fsel34 {
        ...
        pub const SD_CARD_LED: Self = Self::new(3);

        #[doc = "Pin is connected to RGMII_IRQ"]
        pub const RGMII_IRQ: Self = Self::new(2);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Fsel35 {
        ...
        pub const RGMII_START_STOP: Self = Self::new(3);
    ...
    impl Fsel36 {
        ...
        pub const RGMII_RX_OK: Self = Self::new(3);

        #[doc = "Pin is connected to MII_A_RX_ERR"]
        pub const MII_A_RX_ERR: Self = Self::new(2);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Fsel37 {
        ...
        #[doc = "Pin is connected to RGMII_MDIO"]
        pub const RGMII_MDIO: Self = Self::new(3);

        #[doc = "Pin is connected to MII_A_TX_ERR"]
        pub const MII_A_TX_ERR: Self = Self::new(2);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Fsel38 {
        ...
        #[doc = "Pin is connected to RGMII_MDC"]
        pub const RGMII_MDC: Self = Self::new(3);

        #[doc = "Pin is connected to MII_A_CRS"]
        pub const MII_A_CRS: Self = Self::new(2);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Fsel39 {
        ...
        #[doc = "Pin is connected to RGMII_IRQ"]
        pub const RGMII_IRQ: Self = Self::new(3);

        #[doc = "Pin is connected to MII_A_COL"]
        pub const MII_A_COL: Self = Self::new(2);
    }
}
#[doc(hidden)]
#[derive(Copy, Clone, Eq, PartialEq)]
...
pub mod gpfsel4 {
    ...
    impl Fsel40 {
        ...
        pub const PWM_1_0: Self = Self::new(4);
        ...
        pub const SD_1_DAT_4: Self = Self::new(7);

        #[doc = "Pin is connected to SPI0_MISO"]
        pub const SPI_0_MISO: Self = Self::new(3);
    ...
    impl Fsel41 {
        ...
        pub const PWM_1_1: Self = Self::new(4);
        ...
        pub const SD_1_DAT_5: Self = Self::new(7);

        #[doc = "Pin is connected to SPI0_MOSI"]
        pub const SPI_0_MOSI: Self = Self::new(3);
    ...
    impl Fsel42 {
        ...
        pub const SD_1_DAT_6: Self = Self::new(7);

        #[doc = "Pin is connected to SPI0_SCLK"]
        pub const SPI_0_SCLK: Self = Self::new(3);
    ...
    impl Fsel43 {
        ...
        pub const SD_1_DAT_7: Self = Self::new(7);

        #[doc = "Pin is connected to SPI0_CE0_N"]
        pub const SPI_0_CE_0_N: Self = Self::new(3);
    ...
    impl Fsel44 {
        ...
        #[doc = "Pin is connected to SPI0_CE1_N"]
        pub const SPI_0_CE_1_N: Self = Self::new(3);

        #[doc = "Pin is connected to SD_CARD_VOLT"]
        pub const SD_CARD_VOLT: Self = Self::new(2);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Fsel45 {
        ...
        pub const SPI_0_CE_2_N: Self = Self::new(3);

        #[doc = "Pin is connected to SD_CARD_PWR0"]
        pub const SD_CARD_PWR_0: Self = Self::new(2);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
...
pub mod gpfsel5 {
    ...
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Fsel54_SPEC;
    pub type Fsel54 = crate::EnumBitfieldStruct<u8, Fsel54_SPEC>;
    impl Fsel54 {
        #[doc = "Pin is an input"]
        pub const INPUT: Self = Self::new(0);
    ...
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Fsel55_SPEC;
    pub type Fsel55 = crate::EnumBitfieldStruct<u8, Fsel55_SPEC>;
    impl Fsel55 {
        #[doc = "Pin is an input"]
        pub const INPUT: Self = Self::new(0);
    ...
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Fsel56_SPEC;
    pub type Fsel56 = crate::EnumBitfieldStruct<u8, Fsel56_SPEC>;
    impl Fsel56 {
        #[doc = "Pin is an input"]
        pub const INPUT: Self = Self::new(0);
    ...
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Fsel57_SPEC;
    pub type Fsel57 = crate::EnumBitfieldStruct<u8, Fsel57_SPEC>;
    impl Fsel57 {
        #[doc = "Pin is an input"]
        pub const INPUT: Self = Self::new(0);
...
#[doc(hidden)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct GpioPupPdnCntrlReg0_SPEC;
impl crate::sealed::RegSpec for GpioPupPdnCntrlReg0_SPEC {
    type DataType = u32;
}

#[doc = "GPIO Pull-up / Pull-down Register 0"]
pub type GpioPupPdnCntrlReg0 = crate::RegValueT<GpioPupPdnCntrlReg0_SPEC>;

impl NoBitfieldReg<GpioPupPdnCntrlReg0_SPEC> for GpioPupPdnCntrlReg0 {}
impl ::core::default::Default for GpioPupPdnCntrlReg0 {
    #[inline(always)]
    fn default() -> GpioPupPdnCntrlReg0 {
        <crate::RegValueT<GpioPupPdnCntrlReg0_SPEC> as RegisterValue<_>>::new(0)
    }
}

#[doc(hidden)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct GpioPupPdnCntrlReg1_SPEC;
impl crate::sealed::RegSpec for GpioPupPdnCntrlReg1_SPEC {
    type DataType = u32;
}

#[doc = "GPIO Pull-up / Pull-down Register 1"]
pub type GpioPupPdnCntrlReg1 = crate::RegValueT<GpioPupPdnCntrlReg1_SPEC>;

impl NoBitfieldReg<GpioPupPdnCntrlReg1_SPEC> for GpioPupPdnCntrlReg1 {}
impl ::core::default::Default for GpioPupPdnCntrlReg1 {
    #[inline(always)]
    fn default() -> GpioPupPdnCntrlReg1 {
        <crate::RegValueT<GpioPupPdnCntrlReg1_SPEC> as RegisterValue<_>>::new(0)
    }
}

#[doc(hidden)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct GpioPupPdnCntrlReg2_SPEC;
impl crate::sealed::RegSpec for GpioPupPdnCntrlReg2_SPEC {
    type DataType = u32;
}

#[doc = "GPIO Pull-up / Pull-down Register 2"]
pub type GpioPupPdnCntrlReg2 = crate::RegValueT<GpioPupPdnCntrlReg2_SPEC>;

impl NoBitfieldReg<GpioPupPdnCntrlReg2_SPEC> for GpioPupPdnCntrlReg2 {}
impl ::core::default::Default for GpioPupPdnCntrlReg2 {
    #[inline(always)]
    fn default() -> GpioPupPdnCntrlReg2 {
        <crate::RegValueT<GpioPupPdnCntrlReg2_SPEC> as RegisterValue<_>>::new(0)
    }
}

#[doc(hidden)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct GpioPupPdnCntrlReg3_SPEC;
impl crate::sealed::RegSpec for GpioPupPdnCntrlReg3_SPEC {
    type DataType = u32;
}

#[doc = "GPIO Pull-up / Pull-down Register 3"]
pub type GpioPupPdnCntrlReg3 = crate::RegValueT<GpioPupPdnCntrlReg3_SPEC>;

impl NoBitfieldReg<GpioPupPdnCntrlReg3_SPEC> for GpioPupPdnCntrlReg3 {}
impl ::core::default::Default for GpioPupPdnCntrlReg3 {
    #[inline(always)]
    fn default() -> GpioPupPdnCntrlReg3 {
        <crate::RegValueT<GpioPupPdnCntrlReg3_SPEC> as RegisterValue<_>>::new(0)
    }
}
