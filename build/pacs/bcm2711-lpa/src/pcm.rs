...
impl DreqA {
    ...
    #[inline(always)]
    pub fn rx_req(self) -> crate::common::RegisterField<0, 0x7f, 1, 0, u8, u8, DreqA, common::RW> {
    ...
    #[inline(always)]
    pub fn tx_req(self) -> crate::common::RegisterField<8, 0x7f, 1, 0, u8, u8, DreqA, common::RW> {
