...
#![doc = "BCM2837 found in the Raspberry Pi 3 and Zero 2W"]
#[doc(hidden)]
pub mod common;
#[doc(hidden)]
...
pub const CM_PCM: self::CmPcm = self::CmPcm {
    ptr: 0x3f101098u32 as _,
};

#[cfg(feature = "cm_pwm")]
pub const CM_PWM: self::CmPcm = self::CmPcm {
    ptr: 0x3f1010a0u32 as _,
};
...
pub const SPI1: self::Spi1 = self::Spi1 {
    ptr: 0x3f215080u32 as _,
};

#[cfg(feature = "spi2")]
pub const SPI2: self::Spi1 = self::Spi1 {
    ptr: 0x3f2150c0u32 as _,
};
