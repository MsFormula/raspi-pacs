...
impl CsA {
    ...
    #[doc = "RAM Standby"]
    #[inline(always)]
    pub fn stby(self) -> crate::common::RegisterFieldBool<25, 1, 0, CsA_SPEC, crate::common::RW> {
        crate::common::RegisterFieldBool::<25, 1, 0, CsA_SPEC, crate::common::RW>::from_register(
            self, 0,
        )
    }
}
